...
fn fixture_modules_carry_class_and_provenance() {
    ...
    // Timestamp-scaffolded migration: no banner at all — classed generated by
    // the 14-digit filename rule alone (EF Core / Rails scaffolding).
    let migration = find_module(&v, "src/migrations/20260422034143_add_widget.ts");
    assert_eq!(
