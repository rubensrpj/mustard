  ...
  resources: {
    "pt-BR": {
      common: {
        ...
        "sidebar.empty.description":
          "A varredura não achou nenhum mustard.json na pasta onde o servidor foi iniciado. Use o botão de adicionar pasta acima, ou reinicie o servidor apontando --root para onde seus projetos estão.",
        "sidebar.empty.root": "Varrendo {{root}}",
        "sidebar.projectMenu.update": "Atualizar",
        "sidebar.projectMenu.uninstall": "Remover Mustard",
        "sidebar.projectMenu.removeFromList": "Remover da lista",
        // Adicionar pasta à mão. Não há seletor de arquivos: o dashboard é uma
        // página servida pelo servidor local, e o navegador não entrega
        // caminho absoluto para a página — por isso o operador cola o caminho.
        "sidebar.addProject.action": "Adicionar pasta",
        "sidebar.addProject.title": "Adicionar pasta",
        "sidebar.addProject.description":
          "Cole o caminho absoluto da pasta do projeto. Adicionar uma pasta que você tinha removido também a traz de volta para a lista.",
        "sidebar.addProject.placeholder": "/home/voce/projetos/meu-projeto",
        "sidebar.addProject.confirm": "Adicionar",
        "sidebar.addProject.cancel": "Cancelar",
        "sidebar.addProject.toastAdded": "{{path}} entrou na lista",
        "sidebar.hidden.title_one": "{{count}} pasta oculta",
        "sidebar.hidden.title_other": "{{count}} pastas ocultas",
        "sidebar.hidden.restore": "Reexibir",
        "sidebar.toastHidden": "{{name}} saiu da lista",
        "sidebar.toastRestored": "{{name}} voltou para a lista",
    ...
    "en-US": {
      common: {
        ...
        "sidebar.empty.description":
          "The scan found no mustard.json under the directory the server was started in. Use the add-folder button above, or restart it with --root pointing at your projects.",
        "sidebar.empty.root": "Scanning {{root}}",
        "sidebar.projectMenu.update": "Update",
        "sidebar.projectMenu.uninstall": "Uninstall Mustard",
        "sidebar.projectMenu.removeFromList": "Remove from list",
        "sidebar.addProject.action": "Add folder",
        "sidebar.addProject.title": "Add folder",
        "sidebar.addProject.description":
          "Paste the project folder's absolute path. Adding a folder you had removed also brings it back to the list.",
        "sidebar.addProject.placeholder": "/home/you/projects/my-project",
        "sidebar.addProject.confirm": "Add",
        "sidebar.addProject.cancel": "Cancel",
        "sidebar.addProject.toastAdded": "{{path}} is on the list",
        "sidebar.hidden.title_one": "{{count}} hidden folder",
        "sidebar.hidden.title_other": "{{count}} hidden folders",
        "sidebar.hidden.restore": "Restore",
        "sidebar.toastHidden": "{{name}} left the list",
        "sidebar.toastRestored": "{{name}} is back on the list",
