  ...
  resources: {
    "pt-BR": {
      common: {
        ...
        "sidebar.empty.description":
          "A varredura não achou nenhum mustard.json na pasta onde o servidor foi iniciado. Reinicie o servidor apontando --root para onde seus projetos estão.",
    ...
    "en-US": {
      common: {
        ...
        "sidebar.empty.description":
          "The scan found no mustard.json under the directory the server was started in. Restart it with --root pointing at your projects.",
