#!/usr/bin/env node
// apps/dashboard/scripts/check-pages-no-inline-visual.mjs
//
...
//
// Usage:
//   node apps/dashboard/scripts/check-pages-no-inline-visual.mjs [pagesDir]
//
// Exit codes:
//   0 - no violations
...
// devDep via eslint. We resolve from the dashboard and repo
// root so future hoisting changes don't break us.
const require = createRequire(import.meta.url);
const ESTREE_PATH = require.resolve("@typescript-eslint/typescript-estree", {
  paths: [DASHBOARD_ROOT, REPO_ROOT],
});
