...
///
/// Self-contained twin of `apps/rt/build.rs`: build scripts can't share code
/// across crates without a helper crate, and this logic is small enough that a
/// helper crate would be more weight than the duplication.
