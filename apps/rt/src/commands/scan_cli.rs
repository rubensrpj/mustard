...
pub enum ScanCmd {
    ...
    #[command(display_order = 81)] // appended at the tail: slots are a global gapless permutation (see tests/run_command_surface.rs)
    ScanLapidation {
    ...
    #[command(display_order = 74)] // appended at the tail: slots are a global gapless permutation (see tests/run_command_surface.rs)
    ScanPatternsDecline {
    ...
    #[command(display_order = 82)] // tail slot — keep the display_order permutation gapless
    ScanPatternsRelay {
    ...
    #[command(display_order = 75)] // tail slot — keep the display_order permutation gapless
    ScanPatternsSweep {
