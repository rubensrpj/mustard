...
pub enum ScanCmd {
    ...
    #[command(display_order = 79)] // appended at the tail: slots are a global gapless permutation (see tests/run_command_surface.rs)
    ScanLapidation {
    ...
    #[command(display_order = 80)] // tail slot — keep the display_order permutation gapless
    ScanPatternsRelay {
