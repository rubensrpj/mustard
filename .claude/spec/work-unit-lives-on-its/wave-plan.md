...
| 4 | [[wave.work-unit-lives-on-its.4-unit-tools]] | unit-tools | [[wave.work-unit-lives-on-its.3-pr-door]] | git delete removes a unit whole, and a per-branch notebook collects what does not belong to the current spec. |
| 5 | [[wave.work-unit-lives-on-its.5-surface-prune]] | surface-prune | [[wave.work-unit-lives-on-its.3-pr-door]], [[wave.work-unit-lives-on-its.4-unit-tools]] | The six read-only and legacy doors are removed: mustard, status, stats, knowledge, maint and skills. |
| 6 | [[wave.work-unit-lives-on-its.6-surface-fold]] | surface-fold | [[wave.work-unit-lives-on-its.5-surface-prune]] | The pipeline steps stop being doors and the installation flags fold into upsert, leaving exactly four doors. |
