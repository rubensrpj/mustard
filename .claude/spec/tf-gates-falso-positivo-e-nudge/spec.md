...
- [ ] AC6: `approve-spec` SEM marcador falha em strict (exit≠0 com instrução didática) e passa COM marcador; observer grava o marcador só quando a resposta do AskUserQuestion é aprovação; em bg-job sem usuário o Full para no PLAN (teste do fluxo bloqueado limpo).