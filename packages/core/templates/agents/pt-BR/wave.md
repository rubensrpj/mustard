...
Falta algo, uma tarefa pede o que a spec não diz, ou não dá certo (arquivo que não existe, contrato que não fecha): pare e relate o problema e a mudança proposta. Não decida sozinho: ela só segue com o clique do usuário em "Aceitar".
