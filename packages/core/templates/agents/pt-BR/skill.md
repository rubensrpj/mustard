...
- O cabeçalho traz `name: <tarefa>`, `effort: xhigh` e `description: Use quando <o tipo de arquivo, a pasta e as palavras da tarefa>.` — um verbete de índice, não uma frase solta: é por ele que a busca acha a skill certa.
- Depois, nesta ordem:
