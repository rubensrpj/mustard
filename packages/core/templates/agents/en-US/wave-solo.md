...
- `text`: in the project's language, up to 8,000 characters: the changed file in a sentence; for each criterion, the test and its red proof (what was cut, what fell); what you decided outside the request; what's left open, and why.
