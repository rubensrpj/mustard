...
/// `true` quando um texto casa com a onda `n`: a busca por palavras, com o
/// texto dessa onda como único documento. Ela confere se uma tarefa está na
/// onda certa; quem recebe cada item combinado é o dono dele, não a busca.
///
