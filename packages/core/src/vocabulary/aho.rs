...
//!
//! - The public [`crate::vocabulary::VocabularyMatcher`] surface stays
...
//!
//! [`VocabularyMatcher`]: crate::vocabulary::VocabularyMatcher
...
/// through [`crate::vocabulary::VocabularyMatcher`].
...
impl AhoMatcher {
    /// Build the automaton. See [`crate::vocabulary::VocabularyMatcher::from_layers`]
