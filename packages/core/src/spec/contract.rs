...
//!   else. It does not parse legacy headers (that is [`crate::spec`]), does
//!   not open IO ([`crate::meta`] writes `meta.json`).
...
use crate::i18n::UserLocale;
use crate::model::view::{Outcome, Phase, Scope, Stage};
