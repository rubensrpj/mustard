...
//!    fall back to [`crate::vocabulary::VocabularyMatcher::scan`] over the
...
use crate::vocabulary::{Layer, VocabLayer, VocabularyDoc, VocabularyMatcher};
use std::path::Path;
...
"#
    ...
    fn test_loader_with_extension_only(
        ...
        crate::ast::loader_test_helpers::with_extension(
