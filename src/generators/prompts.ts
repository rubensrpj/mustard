 ...
 */
export async function generatePrompts(projectInfo: ProjectInfo, _analysis: Analysis): Promise<GeneratedPrompts> {
...
function generateOrchestratorFallback(): string {
  return `# Orchestrator
...
function generateBugfixFallback(): string {
...
function generateReviewFallback(): string {
...
function generateNamingFallback(projectInfo: ProjectInfo): string {
...
function generateBackendFallback(projectInfo: ProjectInfo): string {
...
function generateFrontendFallback(projectInfo: ProjectInfo): string {
...
function generateDatabaseFallback(projectInfo: ProjectInfo): string {
