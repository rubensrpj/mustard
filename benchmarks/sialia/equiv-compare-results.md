...
Generated 2026-07-08 20:59 by `compare-equiv.ps1`. Model+dict: the post-revert scan (raw PT dictionary back; scan wall-time ~27 s on sialia). Query = raw `pt` + the source's added EN tokens; `grain rank --direct-base 100000`; scored n=13, target-OR-secondary.
...
| hybrid (mt+cooc) | 4/13 | 7/13 | 1,4,5,6 |
